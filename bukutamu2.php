      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Beranda</a></span> <span>Form Pengisian Buku Tamu</span></p>
	            <h1 class="mb-4 bread">BUKU TAMU</h1>
            </div>
          </div>
        </div>
      </div>
...
<div class="card-body">
           ...
           <h3>Tanggapan Anda Sudah di rekam</h3>
		   <h3>Selamat datang di Museum Tanah dan Pertanian </h3>
            </div>
            ...
            <br/>
                ...
                <div class="card-footer">
        <center>
          <button class="btn btn--radius-2 btn--blue-2" type="submit"><a href = "bukutamu.php">kembali</a></button>
