...
<div class="card-body">
            ...
            <table>
            <tr>
                        <td> <div class = "date"> Tanggal </div> </td>
            </br>
            <div class = "value">
            <br/>
            <br/>
            <td> <br/> <br/> <input class="input--style-6"  type = 'text' name = "date" id = "date"> </td>
            <br/>
            </div>
            </tr>
                        </div>
            ...
            <br/>
            <br/>
            <td> <br/> <br/> <br/> <input class="input--style-6"  type = 'text' name = "status" id = "status"> </td>
            <br/>
            </div>
            </tr>
                        </div>
            ...
            <br/>
            <br/>
            <td> <br/> <br/> <br/> <input class="input--style-6"  type = 'text' name = "nama" id = "nama"> </td>
            <br/>
            </div>
            </tr>
                        </div>
            ...
            <div class="form-row">
            <tr>
                        <td><div class = "waktu">waktu Berkunjung</div> </td>
            </br>
            <div class = "value">
            <br/>
            <br/>
            <td> <br/> <br/> <br/> <input class="input--style-6"  type = 'text' name = "waktu" id = "waktu"> </td>
            <br/>
            </div>
            </tr>
                        </div>
            ...
            <br/>
                ...
                <div class="card-footer">
        <center>
          <button class="btn btn--radius-2 btn--blue-2" type="submit"><a href = "kunjungan3.php">Cancel</a></button>
                    <button class="btn btn--radius-2 btn--blue-2" type="submit"><a href = "kunjunganterakhir.php">Reservation</a></button>
        </center>
                </div>
            </div>
        </div>
