...
<script src="datepicker/dist/js/jquery-3.3.1.js"></script>
<script src="datepicker/dist/js/bootstrap-datepicker.js"></script>
  ...
  <body>
    ...
    <!-- END nav -->
		<div class="hero-wrap" style="background-image: url('images/gambar9.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Beranda</a></span> <span>Cek Ketersediaan Jadwal Kunjungan </span></p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 pr-1 aside-stretch">
            <form action="aksiaddkunjungan1.php" method ="POST" class="booking-form">
              <div class="row">
                ...
                <div class="col-md d-flex py-md-4">
                  <div class="form-group align-self-stretch d-flex align-items-end">
					...
					<input type="text" class="form-control" name="tgl" id="tgl"><br>
<script type="text/javascript">
$(function()
  {
    $('#tgl').datepicker({autoclose: true,todayHighlight: true,format: 'yyyy-mm-dd', daysOfWeekDisabled:[0,6]}),
    $('#tgl_akhir').datepicker({autoclose: true,todayHighlight: true,format: 'yyyy-mm-dd'})
                ...
                <div class="col-md d-flex py-md-4">
                  <div class="form-group align-self-stretch d-flex align-items-end">
                    <div class="wrap bg-white align-self-stretch py-3 px-4">
                      <label for="#">Pilih Jenis Rombongan</label>
                ...
                <div class="col-md d-flex">
                  <div class="form-group d-flex align-self-stretch">
                   <a href="kunjungan3.php" class="btn btn-black py-5 py-md-3 px-4 align-self-stretch d-block">
				   <span><input type="submit" name="tmbl" value="cek ketersedian Reservasi "></span>
				   </a>
