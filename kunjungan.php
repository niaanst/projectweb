...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Beranda</a></span> <span>Prosedur Reservasi Kunjungan Museum Pertanian</span></p>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <span class="subheading">Alur Prosedur Kunjungan di Museum Pertanian</span><br />
      <p align="justify"> Berikut adalah alur prosedur kunjungan museum : </p>
      <p align="justify"> 1. Calon pengunjung wajib menggunggah Surat Permohonan Izin Kunjungan yang ditujukan kepada Kepala masing-masing Museum</p>
      <p align="justify"> 2. Calon pengunjung wajib mencantumkan dalam Surat Permohonan Izin Kunjungan yakni : <br /> a) Nama lengkap Institusi / Perguruan Tinggi / Sekolah
      <br /> b) Waktu kunjungan meliputi : tanggal, hari, bulan, tahun dan jam kunjungan <br /> c ) Jumlah pengunjung museum <br />  d) Jumlah pedamping <br />  e) Kontak narahubung yang bisa dihubungi</p>
      <p align="justify">3. Calon Pengunjung menerima balasan dari pihak museum selambatnya 2 X 24 jam melalui email maupun telepon</p>
      <p align="justify">4. Calon Pengunjung datang pada hari dan tanggal yang sudah direservasi </p>
      <p align="justify">5. Pembatalan kunjungan wajib disampaikan 5 hari sebelum waktu kunjungan</p>
      <p align="justify">6. Reservasi hanya ditujukan untuk kunjungan rombongan dengan jumlah orang minimum 6 orang</p>
	   <p align="justify">7. Reservasi ini tidak di gunakan untuk individu</p>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <span class="subheading">Untuk mereservasi kunjungan silahkan klik link dibawah ini</span>
      <p align="center"> Ingin mereservasi ? </p>
      <a href= "kunjungan2.php">[klik disini]</a>
        </div>
      </div>
    </div>  
    </section>
