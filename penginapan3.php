      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Beranda</a></span> <span>Konfirmasi Reservasi Penginapan</span></p>
...
<div class="card-body">
            ...
            <div class="card-footer">
                <div class="line-"></div>
              <h1> Konfirmasi Reservasi Penginapan  </h1>
            </div>
            </br>
            
            
                        <div class="form-row">
           <h3>Reservasi Penginapan Berhasil </h3>
		   <h3> Untuk pemberitahuan kunjungan diterima cek email anda </h3>
            </div>
            ...
            <br/>
                ...
                <div class="card-footer">
        <center>
          <button class="btn btn--radius-2 btn--blue-2" type="submit"><a href = "penginapan.php">kembali</a></button>
