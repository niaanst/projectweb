...
<html lang="en">
  <head>
    <title>Reservasi Penginapan - Museum Pertanian</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a href="penginapan.php" class="nav-link">Penginapan</a></li>
    ...
    <!-- END nav -->
		<div class="hero-wrap" style="background-image: url('images/gambar6.jpeg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Beranda</a></span> <span>Form Registrasi Reservasi Penginapan</span></p>
	            <h1 class="mb-4 bread">Reservasi Penginapan</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-6 order-md-last d-flex">
            ...
            <form action="simpanpenginapan.php" method="get" class="bg-white p-5 contact-form">
      <h2>Isi Form Penginapan</h2>
	 
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Nama" name="nama">
              </div>
        <div class="form-group">
                <input type="text" class="form-control" placeholder="Nomor Hp" name="nomortelepon">
              </div>
        <div class="form-group">
                <input type="text" class="form-control" placeholder="Email" name="email">
              </div>
              <div class="form-group">
        <span class="label-input100">Waktu Check-in</span>
                <input type="date" class="form-control" placeholder="Waktu Check-in" name="checkin">
              </div>
              <div class="form-group">
        <span class="label-input100">Waktu Check-out</span>
                <input type="date" class="form-control" placeholder="Waktu Check-out" name="checkout">
              </div>
              
              <div class="form-group">
        <span class="label-input100">Jumlah Kamar</span>
        <div>
        <select class="js-select2" name="jumlahkamar">
          <option>1</option>
          <option>2</option>
          <option>3</option>
          <option>4</option>
      ...
      <div class="form-group">
        <span class="label-input100">Pembayaran</span>
        <div>
        <select class="js-select2" name="jenispembayaran">
          <option>Bayar di Tempat</option>
          <option>Bayar dengan Kredit Card</option>
          <option>Bayar dengan Debit Card</option>
        </select>
        <div class="dropDownSelect2"></div>
        </div>
      </div>
      <div class="form-group">
                <div class="name">Upload Bukti Pembayaran </div>
          <div class="value">
            <div class="input-group js-input-file">
                            <input class="input-file" type="file" name="filesurat" id="file">
                  ...
                  <input class="btn btn--radius-2 btn--blue-2"  type="submit" name="tmbl" value="Pesan">
              </div>
            </form>
