...
<html lang="en">
  <head>
    <title>Reservasi Kunjungan - Museum Pertanian</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.php">MUSEUM PERTANIAN</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a href="kunjungan.php" class="nav-link">Kunjungan</a></li>
            <li class="nav-item"><a href="penginapan.php" class="nav-link">Penginapan</a></li>
            <li class="nav-item"><a href="bukutamu.php" class="nav-link">Buku Tamu</a></li>
    ...
    <!-- END nav -->
		<div class="hero-wrap" style="background-image: url('images/gambar8.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Beranda</a></span> <span>Form Registrasi Reservasi Kunjungan</span></p>
	            <h1 class="mb-4 bread">Reservasi Kunjungan</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <span class="subheading">Isi Form Registrasi</span>
            <h2>Museum Tanah dan Pertanian</h2>
          </div>
        </div>
...
<div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <form action="simpankunjungan.php" method ="get">
            ...
            <br/>
             <div class="form-row">
                            <div class="waktu"> Pilih waktu Berkunjung </div>
              </br>
                            <div class="value">
                  <br/>
                  <br/>
                                    <select class="input--style-6"  name="waktu" >
            ...
            <table>
            <tr>
                        <td> <div class = "nama"> Nama </div> </td>
            </br>
            <div class = "value">
            <br/>
            <br/>
            <td> <br/> <br/> <input class="input--style-6"  type = 'text' name = "nama" id = "nama"> </td>
            <br/>
            </div>
            </tr>
                        </div>
            ...
            <div class="form-row">
            <tr>
                        <td><div class = "nomoridentitas">Nomor KTP / Passport </div> </td>
            </br>
            <div class = "value">
            <br/>
            <br/>
            <td> <br/> <br/> <br/> <input class="input--style-6"  type = 'text' name = "nomoridentitas" id = "nomoridentitas"> </td>
            <br/>
            </div>
            </tr>
                        </div>
            ...
            <div class="form-row">
            <tr>
                        <td><div class = "kota">Kota</div> </td>
            </br>
            <div class = "value">
            <br/>
            <br/>
            <td> <br/> <br/> <br/> <input class="input--style-6"  type = 'text' name = "kota" id = "kota"> </td>
            <br/>
            </div>
            </tr>
                        </div>
            ...
            <div class="form-row">
            <tr>
                        <td><div class = "negara">Negara</div> </td>
            </br>
            <div class = "value">
            <br/>
            <br/>
            <td> <br/> <br/> <br/> <input class="input--style-6"  type = 'text' name = "negara" id = "negara"> </td>
            <br/>
            </div>
            </tr>
                        </div>
            ...
            <div class="form-row">
            <tr>
                        <td><div class = "kebangsaan">Kebangsaan</div> </td>
            </br>
            <div class = "value">
            <br/>
            <br/>
            <td> <br/> <br/> <br/> <input class="input--style-6"  type = 'text' name = "kebangsaan" id = "kebangsaan"> </td>
            <br/>
            <br/>
            </tr>
                        </div>
            ...
            <table>
            <tr>
                        <td> <div class = "nomortelepon"> Nomor HP / Telepon </div> </td>
            </br>
            <div class = "value">
            <br/>
            <br/>
            <td> <br/> <br/> <br/> <input class="input--style-6"  type = 'text' name = "nomortelepon" id = "nomortelepon"> </td>
            <br/>
            </div>
            </tr>
                        </div>
            ...
            <div class="form-row">
            <tr>
                        <td><div class = "email"> E-mail  </div> </td>
            </br>
            <div class = "value">
            <br/>
            <br/>
            <td> <br/> <br/> <br/> <input class="input--style-6"  type = 'email' name ="email" id = "email"> </td>
            <br/>
            </div>
            </tr>
                        </div>
  ...
  ?>
            ...
            <div class="form-row">
                            <div class="name">Upload  Surat Pengesahan </div>
              </br>
              </br>
                            <div class="value">
            <div class="input-group js-input-file">
			<form method="POST" action="upload.php" enctype="multipart/form-data">
                                    <input type="file" id="upload" name="foto" class="form-control" placeholder="Foto Surat"
                      accept="application/pdf" >
                                    <label class="label--file" for="file"></label>
                                    <span class="input-file__info"></span>
                                </div>
                                <div class="label--desc">Upload Sursat Pengesahan Pihak museum. Max file size 50 MB</div>
                            </div>
        ...
        <center>
          <button  class="btn btn--radius-2 btn--blue-2" type="submit" ><a href = "kunjungan2.php"> Cancel </a></button>
          <input class="btn btn--radius-2 btn--blue-2"  type="submit" name="tmbl" value="reservation">
        </center>
                </div>
            </div>
        </div>
