      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Beranda</a></span> <span>Cek Ketersediaan Reservasi Penginapan</span></p>
              ...
              <div class="row">
                <div class="col-md d-flex py-md-4">
                  <div class="form-group align-self-stretch d-flex align-items-end">
                    <div class="wrap bg-white align-self-stretch py-3 px-4">
                      ...
                      <input type="text" class="form-control checkin_date" placeholder="Pilih Tanggal Check-in">
                    </div>
                  </div>
                </div>
                <div class="col-md d-flex py-md-4">
                  <div class="form-group align-self-stretch d-flex align-items-end">
                    <div class="wrap bg-white align-self-stretch py-3 px-4">
                      <label for="#">Check-out Penginapan</label>
                      <input type="text" class="form-control checkout_date" placeholder="Pilih Tanggal Check-out ">
                    </div>
                  </div>
                </div>
                <div class="col-md d-flex py-md-4">
                ...
                <div class="col-md d-flex">
                  <div class="form-group d-flex align-self-stretch">
                    <a href="penginapan2.php" class="btn btn-black py-5 py-md-3 px-4 align-self-stretch d-block"><span>Cek Ketersediaan Kamar</span></a>
                  </div>
                </div>
              </div>
            </form>
